      ...
      <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-all duration-200">
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-start mb-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {property.occupancyStatus && (
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] sm:text-xs font-medium ${
                      property.occupancyStatus === 'occupied'
                        ...
                        : property.occupancyStatus === 'maintenance'
                  ...
                  >
                    ...
                    {property.occupancyStatus.charAt(0).toUpperCase() +
                      property.occupancyStatus.slice(1)}
                  </span>
                )}
              </div>
              <p className="text-xs sm:text-sm text-gray-600">{property.addressLine2}</p>
            ...
            {averageRating && (
              <div className="flex items-center bg-amber-50 px-2 sm:px-3 py-1 rounded-full self-start sm:self-center">
                <FaStar className="text-amber-400 mr-1.5 text-sm sm:text-base" />
          ...
          {/* Features Grid */}
          <div className="flex flex-wrap gap-3 sm:flex-nowrap mb-4">
            ...
            <div className="flex items-center text-xs sm:text-sm bg-amber-50 px-2 sm:px-3 py-1 rounded-lg">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {property.hasGarden && <Tag icon={<FaTree />} label="Garden" color="emerald" />}
          ...
          <div className="mb-4">
            <div className="flex  gap-2 sm:flex-row sm:space-x-4">
              <MediaButton
                icon={<FaCamera />}
                count={photoCount}
                label="Photos"
          ...
          <div className="pt-4 border-t border-gray-100">
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
              <div className="flex items-center space-x-2 text-xs sm:text-sm">
                <FaHome className="text-gray-400 text-xs sm:text-sm" />
              ...
              {showActions && (
                <div className="flex flex-col gap-2 sm:flex-row sm:space-x-3">
                  <button
                    onClick={onEdit}
                    className="flex items-center justify-center text-xs sm:text-sm text-indigo-600 hover:text-indigo-800 px-2 sm:px-3 py-1.5 rounded-lg hover:bg-indigo-50 transition-colors"
                  >
                    <FaEdit className="mr-1.5" /> Edit
                  </button>
                  <button
                    onClick={handleDeleteClick}
                    className="flex items-center justify-center text-xs sm:text-sm text-rose-600 hover:text-rose-800 px-2 sm:px-3 py-1.5 rounded-lg hover:bg-rose-50 transition-colors"
                  >
